(function() {
    ...
    function eoModalController($scope, $uibModal, $rootScope) {
        ...
        $rootScope.GatewayRateLimitModal = function openModel(input, callback) {
        ...
        $rootScope.Common_SingelInputAndTextareaModal = function openModal(input, callback) {
            var modalInstance = $uibModal.open({
                animation: true,
                templateUrl: 'Common_SingelInputAndTextareaModal',
                controller: 'Common_SingelInputAndTextareaModalCtrl',
                resolve: {
                    input: function() {
                        return input;
                    }
