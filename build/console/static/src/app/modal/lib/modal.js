          ...
          modalRenderDeferObj.promise.then(function () {
            ...
            $q.when(animationPromise).then(function () {
              ...
              if (!($document[0].activeElement && element[0].contains($document[0].activeElement))) {
                /**
                 * @description 自动聚焦取消判断条件，自动对第一个元素聚焦
                 * @author 广州银云信息科技有限公司
                 * @version 5.0
                 */
                // var inputWithAutofocus = element[0].querySelector('[autofocus]');
                var inputWithAutofocus = element[0].querySelector('input[type=text]');
                /**
                 ...
                 */
                if (inputWithAutofocus&&inputWithAutofocus.classList.value.indexOf('input-select')==-1) {
                  let tmpScrollY=window.scrollY;
                  inputWithAutofocus.focus();
                  /**
                   * @description 修改默认scrollTop，防止聚焦之后scroll到顶部
                   */
