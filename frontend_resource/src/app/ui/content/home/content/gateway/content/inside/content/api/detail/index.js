        ...
        .config(['$stateProvider', 'RouteHelpersProvider', function($stateProvider, helper) {
            $stateProvider
                .state('home.gateway.inside.api.detail', {
                    url: '/detail?apiID?groupID?childGroupID',
                    template: '<gateway-api-detail></gateway-api-detail>'
                });
        }])
        .component('gatewayApiDetail', {
            templateUrl: 'app/ui/content/home/content/gateway/content/inside/content/api/detail/index.html',
            controller: gatewayApiDetailController
        })

    gatewayApiDetailController.$inject = ['$scope', '$timeout', 'GatewayResource', '$state', 'CODE', '$rootScope', 'Cache_CommonService','PATH_INFO'];

    function gatewayApiDetailController($scope, $timeout, GatewayResource, $state, CODE, $rootScope, Cache_CommonService,PATH_INFO) {
        var vm = this;
