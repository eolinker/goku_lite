(function() {
    ...
    angular.module('goku')
        ...
        .component('homeGatewayDefault', {
            templateUrl: 'app/ui/content/home/content/gateway/content/default/index.html',
    ...
    function indexController($scope, GatewayResource, $state, CODE, $rootScope, $timeout, $filter) {
        ...
        vm.data.fun.delete = function(arg) {
            ...
            var template = {
                request: {
                    gatewayHashKey: arg.item.gatewayHashKey
                }
            }
        ...
        vm.data.fun.enter = function(arg) {
            $state.go('home.gateway.inside.overview', { gatewayName: arg.item.gatewayName, gatewayHashKey: arg.item.gatewayHashKey });
        }
                ...
                mainObject: {
                    item: {
                        default: [
                            ...
                            { key: '状态', html: '{{item.gatewayStatus==0?\'下线\':\'启用\'}}', keyStyle: { 'width': '160px' } },
